#!/usr/bin/env python3
"""
Celo Hackathon Analyzer with AI Agents and Parallel Execution

This script uses specialized LangChain agents with parallel processing
...
{colors['bold']}This tool uses specialized AI agents with gitingest to analyze GitHub repositories
for code quality and Celo blockchain integration, featuring parallel execution support.{colors['reset']}
"""
    print(banner)
