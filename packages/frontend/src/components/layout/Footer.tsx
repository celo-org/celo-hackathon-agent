      ...
      <div className="analyzer-container">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-lg">ShipMate</span>
            </div>
            <p className="text-sm text-muted-foreground mt-4">
              Analyze your AI projects quickly with comprehensive reports and insights.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-sm text-muted-foreground hover:text-primary transition-colors">Integration</a></li>
        ...
        <div className="border-t border-border pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="text-sm text-muted-foreground">
            © {currentYear} ShipMate. All rights reserved.
          </div>
